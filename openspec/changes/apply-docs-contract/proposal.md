...
workstation-security heeft 5 docs-pagina's zonder contractstructuur; wave 2.
...
- `docs/threat-model.md`, `docs/strategy.md`,
  `docs/supply-chain-cooldown.md` -> `explanation/`;
  `docs/compliance.md` -> `reference/`; `docs/README.md` opnemen in
  `docs/index.md` (stub achterlaten).
- Host-specifieke details horen niet in docs/ — als je ze tegenkomt:
  melden in PR-body, niet verplaatsen.
